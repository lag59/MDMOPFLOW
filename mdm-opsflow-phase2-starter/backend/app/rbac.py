ROLE_PERMISSIONS = {
    ...
    "estimator": ["estimate_read", "estimate_write", "project_read", "intake_read", "intake_review"],
    "dispatcher": ["dispatch_read", "dispatch_write", "project_read", "fleet_read", "intake_read"],
    "accounting": ["finance_read", "finance_write", "project_read", "estimate_read", "intake_read"],
    "payroll": ["payroll_read", "payroll_write", "project_read", "intake_read"],
    ...
    "administrator": ["admin_read", "admin_write", "project_read", "project_write", "intake_read", "intake_write"],
