ROLE_PERMISSIONS = {
    ...
    "accounting": ["finance_read", "finance_write", "project_read", "estimate_read", "intake_read", "extraction_read"],
    ...
    "administrator": ["admin_read", "admin_write", "project_read", "project_write", "intake_read", "intake_write", "extraction_read", "extraction_review", "extraction_approve"],
