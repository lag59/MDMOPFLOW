...
function resolveAuditWindowPresetRange(
  ...
  } else if (preset === "last_60d") {
    start.setUTCDate(start.getUTCDate() - 60);
  } else if (preset === "last_90d") {
    start.setUTCDate(start.getUTCDate() - 90);
  } else if (preset === "last_180d") {
    start.setUTCDate(start.getUTCDate() - 180);
  } else if (preset === "last_365d") {
    start.setUTCDate(start.getUTCDate() - 365);
  } else if (preset === "last_730d") {
    start.setUTCDate(start.getUTCDate() - 730);
  } else if (preset === "last_1095d") {
  ...
  } else if (preset === "last_3650d") {
    start.setUTCDate(start.getUTCDate() - 3650);
  } else if (preset === "last_7300d") {
    start.setUTCDate(start.getUTCDate() - 7300);
  } else if (preset === "last_10950d") {
    start.setUTCDate(start.getUTCDate() - 10950);
  } else {
